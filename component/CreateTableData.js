        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <Stack spacing="24px">
              ...
              <Box>
                <FormLabel htmlFor="foreignkey">Foreign key</FormLabel>
                <AutoResizeTextArea
                  placeholder={
                    "Example: product_id,order_id (if not, enter - ))"
                  }
                  id={"foreignkey"}
                  minH={"1rem"}
                  overflow={"hidden"}
              ...
              <Box>
                <FormLabel htmlFor="desc">Attribute</FormLabel>
                <AutoResizeTextArea
          ...
          <DrawerFooter borderTopWidth="1px">
            ...
            <Button
              ...
              isDisabled={ablecreate ? false : true}
            >
              Create
            </Button>
          </DrawerFooter>
